...
export const directoryDepartmentOptions = [
  ...
  "Phòng Kế toán",
  "Phòng Nhân sự",
  "TT Giải pháp Chính phủ điện tử",
  "Phòng Pháp chế",
  "Văn phòng",
  "Phòng Sản phẩm Giao thông",
  "Phòng Sản phẩm Dịch vụ Viễn thông",
  "Phòng Kiểm thử và Đánh giá sản phẩm",
  "Phòng AI&IoT",
  "Phòng Sản phẩm dịch vụ công",
  "Phòng Triển khai Số hóa",
  "Phòng Kinh doanh",
  "Phòng Dự án",
  "Phòng Đấu thầu",
  "Phòng Triển khai",
  "TT.TKKT&VH-Phòng Vận hành",
  "Phòng Phân tích nghiệp vụ",
  "Phòng Phát triển phần mềm",
  "Phòng Phát triển Giải pháp-TTCPDT",
  "Phòng Phát triển Sản Phẩm-TTCPDT",
  "Phòng Mua Sắm",
  "Phòng Kiểm soát chất lượng",
  "Phòng Triển khai tích hợp",
  "Phòng Triển khai hạ tầng mạng và bảo mật",
  "Phòng Giải pháp và Dịch vụ viễn thông",
  "Phòng Quản trị Kỹ thuật Dự án",
  "Phòng Quản lý Dự án",
  "Phòng Hệ thống tích hợp",
  "Phòng Phần mềm tích hợp",
  "Phòng Tư vấn Giải pháp",
  "TT Tư vấn Dự án",
  "TT.TVDA-Phòng Tư vấn Pháp lý",
  "TT.TVDA-Phòng Tư vấn GPKT",
...
export const apiCatalog = [
  ...
  { method: "GET", path: "/api/settings/profile-options", description: "Returns reusable role and team lists for operator profile and authorization setup." },
  { method: "GET", path: "/api/settings/profile-options/{kind}", description: "Returns one operator profile option list by kind." },
  { method: "PUT", path: "/api/settings/profile-options/{kind}", description: "Replaces one operator profile option list in SQLite." },
  { method: "GET", path: "/api/settings/directory-options", description: "Returns reusable department and work address lists for Keycloak create-user." },
  { method: "GET", path: "/api/settings/directory-options/{kind}", description: "Returns one directory option list by kind." },
  { method: "PUT", path: "/api/settings/directory-options/{kind}", description: "Replaces one directory option list in SQLite." },
